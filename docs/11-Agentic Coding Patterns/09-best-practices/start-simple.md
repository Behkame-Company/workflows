...
- [Transparency and Observability](./transparency.md) — when you do build agents, make them observable
- [Error Recovery](./error-recovery.md) — handle failures gracefully
- [Over-Engineering Anti-Pattern](../10-anti-patterns/over-engineering.md) — what happens when you skip this advice
- [Testing Agentic Systems](./testing-agents.md) — measure agent effectiveness
