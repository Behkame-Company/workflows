...
- [Templates](./templates.md) — ready-to-use configurations for your projects
- [Troubleshooting](./troubleshooting.md) — when things go wrong
- [Resources](./resources.md) — further reading and tools
- [Best Practices](../09-best-practices/testing-strategy.md) — testing strategy for agent-generated code
