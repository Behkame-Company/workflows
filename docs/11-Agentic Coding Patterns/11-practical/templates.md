...
- [Troubleshooting](./troubleshooting.md) — when templates aren't producing expected results
- [FAQ](./faq.md) — common questions about agent configuration
- [Copilot Agent Patterns](../06-copilot-agent-patterns/copilot-instructions.md) — deep dive on copilot-instructions.md
- [Skills and Custom Agents](../08-skills-and-custom-agents/skill-creation.md) — building skills from templates
