...
- 🔗 [Preventing Secret Leaks](preventing-leaks.md) — Comprehensive leak prevention strategies
- 🔗 [Git Secrets and Pre-Commit Hooks](git-secrets.md) — Catch secrets at commit time
- 🔗 [Secure Coding Instructions for AI Agents](../03-code-safety/secure-coding-instructions.md) — Instruct AI to handle secrets safely
