...
- [Prompt Injection Defense Strategies](./defense-strategies.md) — All known defenses and their effectiveness
- [Tool Poisoning Attacks](./tool-poisoning.md) — MCP-specific injection through tool descriptions
- [What Is Prompt Injection?](./what-is-prompt-injection.md) — Foundational understanding of the attack class
- [Trust Boundaries in AI Development](../01-fundamentals/trust-boundaries.md) — Where injection exploits boundary weaknesses
