...
- [Least Privilege for AI Agents](./least-privilege.md) — Minimize permissions inside the sandbox
- [Network Access Control](./network-access.md) — Fine-grained network policies for sandboxes
- [AI Agent Permission Models](./permission-models.md) — Configure permissions within your sandbox
- [Defense in Depth for AI Pipelines](../01-fundamentals/defense-in-depth.md) — How sandboxing fits into the broader security model
