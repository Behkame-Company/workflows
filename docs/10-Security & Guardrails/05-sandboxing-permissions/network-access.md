...
- [Sandboxed Execution for AI Agents](./sandboxed-execution.md) — Container and VM isolation techniques
- [Least Privilege for AI Agents](./least-privilege.md) — Network control as part of least privilege
- [AI Agent Permission Models](./permission-models.md) — Tool-level permission configuration
- [LLM01: Prompt Injection](../06-owasp-llm-top-10/llm01-prompt-injection.md) — The attack that makes network control critical
