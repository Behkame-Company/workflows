...
- [AI Agent Permission Models](./permission-models.md) — Detailed permission configuration for each AI tool
- [Sandboxed Execution](./sandboxed-execution.md) — Add isolation as a second layer of defense
- [Network Access Control](./network-access.md) — Control network access as part of least privilege
- [LLM08: Excessive Agency](../06-owasp-llm-top-10/llm08-excessive-agency.md) — The OWASP risk that least privilege mitigates
