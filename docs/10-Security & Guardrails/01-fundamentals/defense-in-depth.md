...
- [Trust Boundaries in AI Development](./trust-boundaries.md) — Map where each layer should be enforced
- [Prompt Injection Defense Strategies](../02-prompt-injection/defense-strategies.md) — Deep dive into Layer 1 techniques
- [Tool Poisoning Attacks](../02-prompt-injection/tool-poisoning.md) — Understand threats at the MCP tool layer
- [Why AI Security Is Different](./why-ai-security-is-different.md) — Context for why these layers are necessary
