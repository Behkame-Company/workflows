...
- [Why AI Security Is Different](./why-ai-security-is-different.md) — Understand the fundamental paradigm shift
- [Threat Modeling for AI Workflows](./threat-modeling.md) — Systematically identify threats at each boundary
- [Defense in Depth for AI Pipelines](./defense-in-depth.md) — Layer controls across boundaries
- [Prompt Injection in AI Coding Tools](../02-prompt-injection/injection-in-coding-tools.md) — The primary threat exploiting boundary weaknesses
