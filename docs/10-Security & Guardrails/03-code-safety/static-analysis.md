...
- 🔗 [AI-Generated Code Risks](ai-generated-code-risks.md) — Understand what SAST is catching
- 🔗 [Secure Coding Instructions for AI Agents](secure-coding-instructions.md) — Complement scanning with preventive instructions
- 🔗 [Code Review Practices for AI-Generated Code](code-review-ai-output.md) — Human review for what SAST can't catch
- 🔗 [Git Secrets and Pre-Commit Hooks](../04-secrets-management/git-secrets.md) — Catch secrets before they're committed
