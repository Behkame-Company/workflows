...
- [Measuring AI Impact](measuring-ai-impact.md) — The overall measurement framework
- [Productivity Metrics](productivity-metrics.md) — Balance quality data with velocity metrics
- [ROI Analysis](roi-analysis.md) — Quality improvements factor into ROI calculations
- [AI Code Review Workflow](../04-review-processes/ai-code-review-workflow.md) — Review practices that catch quality issues
- [Review Checklists](../04-review-processes/review-checklists.md) — Structured review for AI-generated code
- [Code Quality Standards](../03-standards-and-conventions/code-quality-standards.md) — Team quality standards AI must meet
- [Metrics Theater](../10-anti-patterns/metrics-theater.md) — When quality metrics become misleading
- [Compliance and Audit](../06-governance-and-policies/compliance-and-audit.md) — Quality metrics for regulatory compliance
