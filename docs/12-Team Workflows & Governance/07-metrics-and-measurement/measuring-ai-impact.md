...
- [Productivity Metrics](productivity-metrics.md) — Deep dive into velocity and throughput measurement
- [Quality Metrics](quality-metrics.md) — Detailed quality tracking with AI tools
- [ROI Analysis](roi-analysis.md) — Building the business case from your measurements
- [AI Usage Policy](../06-governance-and-policies/ai-usage-policy.md) — Policy framework that metrics should support
- [Feedback Loops](../09-best-practices/feedback-loops.md) — Using measurement data to continuously improve
- [Metrics Theater](../10-anti-patterns/metrics-theater.md) — What happens when measurement goes wrong
- [Rollout Strategy](../05-scaling-ai-across-teams/rollout-strategy.md) — How measurement fits into phased adoption
- [Retrospectives and Learning](../08-knowledge-sharing/retrospectives.md) — Using metrics in team retrospectives
