...
- [Return to the developer onboarding guide →](developer-onboarding.md)
- [Review tool setup to catch configuration issues →](tool-setup-checklist.md)
- [Learn about code quality standards →](../03-standards-and-conventions/code-quality-standards.md)
- [Understand the AI code review process →](../04-review-processes/ai-code-review-workflow.md)
