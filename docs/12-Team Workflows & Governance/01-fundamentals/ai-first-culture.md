...
- [Start onboarding developers effectively →](../02-onboarding/developer-onboarding.md)
- [Learn common beginner mistakes to avoid →](../02-onboarding/beginner-mistakes.md)
- [Create instruction file standards →](../03-standards-and-conventions/instruction-file-standards.md)
- [Build a shared prompt library →](../03-standards-and-conventions/prompt-library.md)
