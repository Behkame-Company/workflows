...
- [Assess your team's AI maturity →](maturity-model.md)
- [Understand the team lead's role in AI adoption →](role-of-team-lead.md)
- [Build an AI-first team culture →](ai-first-culture.md)
- [Create your team instruction file standards →](../03-standards-and-conventions/instruction-file-standards.md)
