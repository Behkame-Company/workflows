...
- [AI Usage Policy](ai-usage-policy.md) — The overarching policy framework that references these data handling requirements
- [Intellectual Property & AI](intellectual-property.md) — How data privacy intersects with IP protection
- [Compliance and Audit for AI Development](compliance-and-audit.md) — Regulatory frameworks requiring data protection controls

### Metrics and Measurement
- [Measuring AI Impact](../07-metrics-and-measurement/measuring-ai-impact.md) — Track data-related incidents alongside productivity metrics
- [AI Quality Metrics](../07-metrics-and-measurement/ai-quality-metrics.md) — Quality metrics that factor in data handling compliance

### Knowledge Sharing
- [Internal Documentation](../08-knowledge-sharing/internal-documentation.md) — Document your data classification decisions for the team
- [Training and Workshops](../08-knowledge-sharing/training-and-workshops.md) — Run data privacy training for AI tool users

### Security Foundations
- [Security Guardrails](../05-scaling-ai-across-teams/security-guardrails.md) — Technical enforcement of data protection policies
- [AI Code Review Standards](../04-review-processes/ai-code-review-standards.md) — Review processes that catch data exposure in AI-generated code

### Best Practices
- [Prompt Engineering Best Practices](../09-best-practices/prompt-engineering-best-practices.md) — Write prompts that avoid leaking sensitive data
- [Common Anti-Patterns](../10-anti-patterns/common-anti-patterns.md) — Data handling mistakes to avoid
