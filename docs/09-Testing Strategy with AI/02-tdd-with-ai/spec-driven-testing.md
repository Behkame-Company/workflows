...
- [Writing Tests First for AI](writing-tests-first.md) — when you don't have a formal spec
- [AI Test Generation Patterns](../03-test-generation/generation-patterns.md) — more patterns beyond spec-driven
- [Unit Test Generation](../03-test-generation/unit-test-generation.md) — generating isolated unit tests
- [Test as Specification](../01-fundamentals/test-as-specification.md) — why tests are the best specifications
