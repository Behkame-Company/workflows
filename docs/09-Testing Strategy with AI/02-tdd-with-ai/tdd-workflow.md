...
- [Writing Tests First for AI](writing-tests-first.md) — techniques for writing tests that guide AI effectively
- [Test-Driven Bug Fixing](test-driven-bug-fixing.md) — applying the TDD loop to bug fixes
- [Spec-Driven Testing](spec-driven-testing.md) — generating tests from formal specifications
- [Why Testing Matters More with AI](../01-fundamentals/why-testing-matters-more.md) — the foundational argument for test-first AI workflows
