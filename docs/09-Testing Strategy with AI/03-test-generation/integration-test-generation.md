...
- [Unit Test Generation](unit-test-generation.md) — when isolation is sufficient
- [Edge Case Discovery](edge-case-discovery.md) — finding integration edge cases
- [AI Test Generation Patterns](generation-patterns.md) — all five generation patterns
- [Testing Pyramid with AI](../01-fundamentals/testing-pyramid-with-ai.md) — balancing unit vs integration
